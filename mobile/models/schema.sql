...
--
-- Current schema version: 1 (models/migrations/001_initial.ts)
...
-- Completed sessions. Append-only. Mirrored async to Firestore
-- users/{uid}/sessions/{id}. The task snapshot is flattened into columns.
